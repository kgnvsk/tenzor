...
export function AnomalousMatterHero({
  ...
  return <section role="banner" className="relative w-full h-screen bg-background text-foreground overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        {/* Center ellipse */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1200px] h-[600px] rounded-full bg-gradient-radial from-orange-600/40 via-orange-800/25 via-orange-900/15 to-transparent blur-[120px]" />
        
        {/* Top left accent */}
        <div className="absolute -top-20 -left-20 w-[600px] h-[800px] rounded-full bg-gradient-radial from-orange-500/30 via-orange-700/20 to-transparent blur-[100px]" />
        
        {/* Bottom right accent */}
        <div className="absolute -bottom-40 -right-40 w-[700px] h-[700px] rounded-full bg-gradient-radial from-orange-600/35 via-orange-800/20 to-transparent blur-[110px]" />
        
        {/* Middle right accent */}
        <div className="absolute top-1/3 -right-20 w-[500px] h-[900px] rounded-full bg-gradient-radial from-orange-500/25 via-orange-700/15 to-transparent blur-[90px]" />
      </div>
