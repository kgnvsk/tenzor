    ...
    <div className={clsx("relative w-full", className)} id={id}>
      <button
        ...
        className={clsx(
          ...
          "rounded-[24px] px-6 sm:px-8 py-3 w-full sm:min-w-[260px]",
      ...
      >
        <TrendingUp
          ...
          aria-hidden="true"
        />
        <div className="ui-anim-txt-wrapper relative flex min-w-[8em] items-center whitespace-nowrap">
          <div
            className={clsx(
          ...
          >
            {Array.from(labelIdle).map((ch, i) => (
              <span key={i} className="ui-anim-letter inline-block" style={{ whiteSpace: 'pre' }}>
                {ch}
              </span>
            ))}
          </div>
