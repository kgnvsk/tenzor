...
export const Timeline = ({ data, sectionTitle }: { data: TimelineEntry[]; sectionTitle?: string }) => {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-center mb-4 text-foreground">
